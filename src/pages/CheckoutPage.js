...
const orderData = {
    ...
    items: itemsToDisplay.map((item) => ({
        ...
        product_variant_id: item.product_variant_id ? item.product_variant_id : null, // Set to null if variant ID does not exist
        quantity: item.quantity,
        price: item.price,
        image: item.image,
        // Include variant details only if they exist
